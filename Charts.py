...
if __name__ == "__main__":
    ...
    for column in columns:
        ...
        description = (
    f"There have been {HTML_STRING}{latest_week[column]}{HTML_STRING} "
    f"{column.lower()} incidents in Chicago for the week of {first_day_of_week}. "
    f"This is a {change_type} of {HTML_STRING}{percentage_change:.2f}%{HTML_STRING}. "
    f"A difference of {latest_week[column] - latest_week[f'{column}_average']:.0f} incidents."
    )
