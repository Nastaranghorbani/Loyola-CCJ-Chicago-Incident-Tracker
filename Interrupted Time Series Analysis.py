...
if __name__ == "__main__":
    ...
    # Group the data by 'year' and 'week', and sum only numeric columns
    numeric_cols = df.select_dtypes(include=[np.number]).columns.tolist()  # selecting only numeric columns
    week_sum = df.groupby(['year', 'week'])[numeric_cols].sum().reset_index()
